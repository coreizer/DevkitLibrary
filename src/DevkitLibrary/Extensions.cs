...
namespace DevkitLibrary
{
   public sealed class Extensions
   {
      ...
      public sbyte ReadSByte(uint address) => (sbyte)this._devkit.GetMemory(address, 1)[0];

      public byte ReadByte(uint address) => this._devkit.GetMemory(address, 1)[0];

      public bool ReadBool(uint address) => this._devkit.GetMemory(address, 1)[0] > 0;
      ...
      public byte[] ReadBytes(uint address, int length) => this._devkit.GetMemory(address, (uint)length);
      ...
      public void WriteSByte(uint address, sbyte value) => this._devkit.SetMemory(address, new byte[] { (byte)value });

      public void WriteByte(uint address, byte value) => this._devkit.SetMemory(address, new byte[] { value });

      public void WriteBytes(uint address, params byte[] value) => this._devkit.SetMemory(address, value);
      ...
      public void WriteBool(uint address, bool value) => this._devkit.SetMemory(address, new byte[] { value ? (byte)0x01 : (byte)0x00 });
